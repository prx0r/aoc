# car_detailers campaign — marketing strategy

## Channels (£0 first)
Instagram + TikTok + Maps. Paid only after organic proves saves + DMs. Never split early
spend across platforms.

## Angles (in order)
photo-quote triage, weather-reshuffle, repeats.

## Lead proof
incomplete quote requests.

## Close
DM DETAIL pilot. One CTA per deck. Founding rate for first 3 (feedback + referral +
case study).
