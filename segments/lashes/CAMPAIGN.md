# lashes campaign — marketing strategy

## Channels (£0 first)
Instagram + GBP + booking platforms. Paid only after organic proves saves + DMs. Never split early
spend across platforms.

## Angles (in order)
safety-first, consent, intervals.

## Lead proof
patch-test risk + fill intervals.

## Close
DM LASHES pilot. One CTA per deck. Founding rate for first 3 (feedback + referral +
case study).
