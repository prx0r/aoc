# cleaners campaign — marketing strategy

## Channels (£0 first)
Local FB groups + GBP + Maps. Paid only after organic proves saves + DMs. Never split early
spend across platforms.

## Angles (in order)
win-back, unbilled-extras, chasing-time.

## Lead proof
recoverable paused-plan revenue.

## Close
DM CLEAN pilot. One CTA per deck. Founding rate for first 3 (feedback + referral +
case study).
