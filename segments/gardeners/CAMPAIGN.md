# gardeners campaign — marketing strategy

## Channels (£0 first)
Maps + directories + FB + street re-canvass. Paid only after organic proves saves + DMs. Never split early
spend across platforms.

## Angles (in order)
round-discipline, paper-risk, recanvass.

## Lead proof
skips + unchased debt.

## Close
DM ROUND pilot. One CTA per deck. Founding rate for first 3 (feedback + referral +
case study).
