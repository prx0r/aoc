# driving_instructors campaign — marketing strategy

## Channels (£0 first)
Maps + directories + referrals. Paid only after organic proves saves + DMs. Never split early
spend across platforms.

## Angles (in order)
gap-backfill, waiting-list, progress.

## Lead proof
cancellation gaps.

## Close
DM LESSONS pilot. One CTA per deck. Founding rate for first 3 (feedback + referral +
case study).
