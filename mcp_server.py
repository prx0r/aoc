...
def aoc_status():
    ...
    return {"templates": ["opportunity", "before_after", "faq", "social_proof", "demo", "diagnostic", "teardown", "comparison", "annuity", "retention", "waitlist"], "segments": SEGMENT_IDS, "hooks": total, "receipts": n, "publish": "manual-only"}
